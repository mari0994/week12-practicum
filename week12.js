...
const makeTwentyOne = () => {
	resultTwentyOne.innerText = Math.floor((Math.random() * 10) + 1);
};
...
const makeTwentyThree = () => {
	num1 = 2;
	num2 = 5;
	resultTwentyThree.innerText = Math.pow(num1,num2);
};
...
const makeTwentySeven = () => {
	resultTwentySeven.innerText = Math.floor(Math.random() * (101-50) + 50);
};
...
const makeTwentyEight = () => {
	const num = 4.47;
	resultTwentyEight.innerText = Math.ceil(num);
};
...
const makeTwentyNine = () => {
	const num = 16;
	resultTwentyNine.innerText = Math.sqrt(num);
};
